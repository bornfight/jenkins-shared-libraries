def call(String repoName) {
    ...
    dir('code-metrics-observatory') {
        sh 'composer install'
        configFileProvider([configFile(fileId: 'c3d7339a-64c3-43ed-a9f0-51a2423f267c', targetLocation: '.env.local'), configFile(fileId: 'c3d7339a-64c3-43ed-a9f0-51a2423f267c', targetLocation: '.env.test.local')]) {
